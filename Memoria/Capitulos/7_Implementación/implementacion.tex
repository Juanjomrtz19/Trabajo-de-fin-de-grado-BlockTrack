...
Luego, se crearan los test para testear el contrato inteligente utilizando librerias javascript como MOCHA.\\
...
\subsubsection{Descripción del flujo (código mostrado)}
\begin{enumerate}

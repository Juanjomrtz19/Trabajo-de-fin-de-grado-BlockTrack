...
\section{Problemas en la logística de transporte de mercancías}
...
Se estima que la parte de la entrega de la última milla como porcentaje del costo total de la entrega es de hasta un 50\% en algunos países.
...
desaparecido en algún punto del proceso. Lo más frustrante fue no tener forma de comprobar en qué momento había fallado o desaparecido la batería portátil y encima de todo
...
El problema principal a resolver en este proyecto es la falta de trazabilidad y transparencia en el proceso de transporte de mercancías por carretera. A medida que los productos se mueven entre los distintos
actores de la cadena de suministro, es importante seguir correctamente el estado y el poseedor actual de cada remesa para evitar pérdidas, retrasos o errores en la entrega final al cliente.
Actualmente, los sistemas de seguimiento y gestión de envíos al ser su naturaleza centralizados, son vulnerables a fallos, manipulaciones y fraudes. Esto genera desconfianza entre los participantes de la cadena de suministro y
afecta negativamente a la eficiencia y seguridad del transporte de mercancías. \\

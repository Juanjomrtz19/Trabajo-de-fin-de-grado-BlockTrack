...
\subsection{Desarrollo y análisis del software}
...
ChatGPT plus para la generación de imágenes y generación de código, este servicio tiene un coste de 23 euros al mes, por lo que el coste total por 4 meses será de 92 euros.\\
IDE para el frontend, el backend y el desarrollo de smart contracts: Visual Studio Code. Este IDE es gratuito.\\
Postman para depurar API. Esta herramienta es gratuita.\\
Github para el control de versiones. Esta herramienta es gratuita.\\
Framework para el desarrollo del frontend: React. Esta herramienta es gratuita.\\
Framework para el desarrollo del backend: Express. Esta herramienta es gratuita.\\
Base de datos: mysql. Esta herramienta es gratuita.\\
Web3.js para la conexión con la blockchain. Esta herramienta es gratuita.\\


\subsection{Presupuesto total}
\begin{figure}[H]
    \centering
    \includegraphics[width=1.2\textwidth]{imagenes/Planificacion/costes.png}

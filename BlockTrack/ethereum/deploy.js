// deploy-raw.js  (ESM, sin hardhat plugins)
import { JsonRpcProvider, Wallet, ContractFactory } from 'ethers';
import { promises as fs } from 'fs';
import path from 'path';

// 👇 IMPORTA DESDE DONDE TÚ LO TIENES (artifacts/build)
import envioFactory from './build/EnvioFactory.json' with { type: 'json' };

// RPC del nodo de Hardhat
const provider = new JsonRpcProvider('http://127.0.0.1:8545');

// Usa una private key del nodo (la #0 vale):
...
async function main() {
  ...
  // Normaliza bytecode según el formato del JSON (puede ser .bytecode o .evm.bytecode.object)
  ...
  // Si el constructor tiene args, pásalos aquí:
